  ...
  },
  {
    elements: [
      ...
      },
      {
        ...
        title: "How courteous were our doctors on a scale of 1 (not at all) to 5 (very courteous)?",
        type: "rating",
        rateMin: 0,
        rateMax: 5
      },
      {
        ...
        title: "How empathetic were our doctors on a scale of 1 (not at all) to 5 (very empathetic)?",
        type: "rating",
        rateMin: 0,
        rateMax: 5
      },
      {
        ...
        title: "How well did our doctors explain things to you on a scale of 1 (poor) to 5 (excellent)?",
        type: "rating",
        rateMin: 0,
        rateMax: 5
      },
      {
        name: "doctorsExplanationRating",
        title: "How skillful were our doctors on a scale of 1 (not skillful) to 5 (highly skillful)?",
        type: "rating",
        rateMin: 0,
        rateMax: 5
      },
      {
        name: "doctorsExplanationRating",
        title: "How professional were our doctors on a scale of 1 (not at all professional) to 5 (very professional)?",
        type: "rating",
        rateMin: 0,
        rateMax: 5
      }
