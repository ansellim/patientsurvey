...
export const DoctorEmpathyScore = () => {
    ...
    return (
        <>
            ...
            <SmallCard metricName="Doctor Empathy" score={Math.round(score.average_score * 100) / 5} numFeedback={score.num_feedbacks}></SmallCard>
