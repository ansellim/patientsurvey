...
export const StaffExplanationScore = () => {
    ...
    return (
        <>
            ...
            <SmallCard metricName="Staff Explanation" score={Math.round(score.average_score * 100) / 5} numFeedback={score.num_feedbacks}></SmallCard>
